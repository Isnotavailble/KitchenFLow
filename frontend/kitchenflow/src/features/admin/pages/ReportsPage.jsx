  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <AdminPageHeader title="Reports & Analytics">
        ...
        <button
          type="button"
          className="h-8 px-3.5 bg-white hover:bg-zinc-50 border border-zinc-200/90 text-zinc-700 rounded-xl text-xs font-bold shadow-2xs transition active:scale-[0.96] flex items-center space-x-1.5 cursor-pointer"
        >
          <Download className="w-3.5 h-3.5 text-[#FF5C39]" />
      ...
      <div className="p-6 max-w-7xl mx-auto w-full space-y-4 flex-1">
        <div className="py-24 bg-white rounded-2xl border border-zinc-200/80 flex flex-col items-center justify-center text-center px-4 shadow-xs">
          <div className="w-12 h-12 rounded-2xl bg-orange-50 border border-orange-100 flex items-center justify-center text-[#FF5C39] mb-3">
            <BarChart3 className="w-6 h-6 text-[#FF5C39]" />
          </div>
          <h3 className="text-sm font-bold text-zinc-800">Reports & Financial Module</h3>
          <p className="text-xs text-zinc-400 mt-1 max-w-sm">
            Sales history, category revenue breakdown, and exportable financial audits.
          </p>
        </div>
      </div>
    </div>
